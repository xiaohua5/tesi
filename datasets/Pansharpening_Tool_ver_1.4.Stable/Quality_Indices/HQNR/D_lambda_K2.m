function Dl = D_lambda_K2(fused,ms,ratio,sensor,tag,S)
%
...
%
% keyboard
fused_degraded = MTF(fused,sensor,tag,ratio);
fused_degraded = imresize(fused_degraded,1/ratio,'nearest');
ms_degraded = imresize(ms,1/ratio,'nearest');
[Q2n_index,~] = q2n(ms_degraded,fused_degraded,S,S);
