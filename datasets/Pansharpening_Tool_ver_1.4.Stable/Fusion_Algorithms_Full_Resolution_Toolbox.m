...
MatrixResults_FR = zeros(NumAlgs,NumIndexes);
...
MatrixResults_FR(1,:) = [D_lambda_EXP,D_S_EXP,QNRI_EXP];
...
MatrixResults_FR(2,:) = [D_lambda_PCA,D_S_PCA,QNRI_PCA];
...
MatrixResults_FR(3,:) = [D_lambda_IHS,D_S_IHS,QNRI_IHS];
...
MatrixResults_FR(4,:) = [D_lambda_Brovey,D_S_Brovey,QNRI_Brovey];
...
MatrixResults_FR(5,:) = [D_lambda_BDSD,D_S_BDSD,QNRI_BDSD];
...
MatrixResults_FR(6,:) = [D_lambda_GS,D_S_GS,QNRI_GS];
...
MatrixResults_FR(7,:) = [D_lambda_GSA,D_S_GSA,QNRI_GSA];
...
MatrixResults_FR(8,:) = [D_lambda_PRACS,D_S_PRACS,QNRI_PRACS];
...
MatrixResults_FR(9,:) = [D_lambda_HPF,D_S_HPF,QNRI_HPF];
...
MatrixResults_FR(10,:) = [D_lambda_SFIM,D_S_SFIM,QNRI_SFIM];
...
MatrixResults_FR(11,:) = [D_lambda_Indusion,D_S_Indusion,QNRI_Indusion];
...
MatrixResults_FR(12,:) = [D_lambda_ATWT,D_S_ATWT,QNRI_ATWT];
...
MatrixResults_FR(13,:) = [D_lambda_AWLP,D_S_AWLP,QNRI_AWLP];
...
MatrixResults_FR(14,:) = [D_lambda_ATWTM2,D_S_ATWTM2,QNRI_ATWTM2];
...
MatrixResults_FR(15,:) = [D_lambda_ATWTM3,D_S_ATWTM3,QNRI_ATWTM3];
...
MatrixResults_FR(16,:) = [D_lambda_MTF_GLP,D_S_MTF_GLP,QNRI_MTF_GLP];
...
MatrixResults_FR(17,:) = [D_lambda_MTF_GLP_HPM_PP,D_S_MTF_GLP_HPM_PP,QNRI_MTF_GLP_HPM_PP];
...
MatrixResults_FR(18,:) = [D_lambda_MTF_GLP_HPM,D_S_MTF_GLP_HPM,QNRI_MTF_GLP_HPM];
...
MatrixResults_FR(19,:) = [D_lambda_MTF_GLP_CBD,D_S_MTF_GLP_CBD,QNRI_MTF_GLP_CBD];

%% Print in LATEX

matrix2latex(MatrixResults_FR,'Real_Dataset.tex', 'rowLabels',[{'EXP'},{'PCA'},{'IHS'},{'Brovey'},{'BDSD'},{'GS'},{'GSA'},{'PRACS'},{'HPF'},{'SFIM'},{'Indusion'},{'ATWT'},{'AWLP'},...
