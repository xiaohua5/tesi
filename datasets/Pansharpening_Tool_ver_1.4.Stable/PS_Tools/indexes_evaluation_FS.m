...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [D_lambda,D_S,HQNR_index,SAM_index,sCC] = indexes_evaluation_FS(I_F,I_MS_LR,I_PAN,L,th_values,I_MS,sensor_MS,tag_MS,sensor_PAN,tag_PAN,ratio,Qblocks_size)
...
[HQNR_index,D_lambda,D_S]= QNR(I_F,I_MS,I_PAN,sensor_PAN,ratio,Qblocks_size);
