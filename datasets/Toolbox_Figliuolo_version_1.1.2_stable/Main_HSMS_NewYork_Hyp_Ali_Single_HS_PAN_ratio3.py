...
parser.add_argument('-s', '--sensor', type=str, default='NEWYORK_Ratio3', #rimettere RIOWV2 ---------
...
Groups_Masi_matlab = sio.loadmat('Groups_MANUAL8_NewYork_Hyp_WV3_ratio_3_Fusion_HS_PAN.mat')
Groups_Masi = np.array(Groups_Masi_matlab['Groups'])
Ass_vector_matlab = sio.loadmat('ass_vector_HS_MS_MANUAL_8_Single_NewYork_ratio_3_Fusion_HS_PAN.mat')
