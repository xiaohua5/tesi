...
def PNN_test_HS_PAN_ratio_3 (I_MS,I_MS_LR,I_PAN0_LR,inputImg, param,net,path,mode,epochs):    #iniz è uguale a 0 QUI ERA IL PROBLEMA FACEVA UN OVERRIDE
...
#    import pdb; pdb.set_trace()
	...
	# modifica 15_03 PER RIO
#    param['L']=np.array(inputImg['L'],dtype='double')
#    param['ratio']=np.array(inputImg['ratio'],dtype='double')
#	
