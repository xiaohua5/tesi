# -*- coding: utf-8 -*-
"""
Created on Wed Apr 25 09:32:29 2018
...
def PNN_test_HSMS_Random (I_MS,I_MS_LR,I_PAN,inputImg, param,net,path,mode,epochs):    #iniz è uguale a 0 QUI ERA IL PROBLEMA FACEVA UN OVERRIDE
...
#    import pdb; pdb.set_trace()	
    ...
    param['ratio']=4 # modificato il 04/04    
    param['lr'] = 0.0001     # prec 10e-4
...
#        I_MS = interp23(I_MS_LR, param['ratio'])                # interp23
#        if len(NDxI_LR)!=0:
...
#        import pdb; pdb.set_trace()
#        I_PAN = np.squeeze(I_PAN, axis = 0)     # aggiunta il 25/04
...
#        I_in_new = I_in[0,0:10,:,:]
#        I_in_new = np.expand_dims(I_in_new,axis=0)
